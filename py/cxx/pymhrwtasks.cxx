  ...
  boost::python::scope().attr("mhrwtasks") = mhrwtaskssubmod;
  {
    ...
    { typedef Py::MHRandomWalkValueHistogramTaskResult Kl;
      boost::python::class_<Py::MHRandomWalkValueHistogramTaskResult>(
          ...
          "    An object of type :py:class:`ValueHistogramWithBinningMHRWStatsCollectorResult` detailing "
          "the result of the stats collecting class which is responsible for determining the final histogram, "
          "and carrying out the binning analysis to come up with error bars.",
          boost::python::no_init)
