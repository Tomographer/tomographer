...
build_v5_0aaa_15_g287a5ae_optim_release = TomographerBuild('v5.0aaa-15-g287a5ae', cmake_release_opts + [
    '-DCMAKE_CXX_COMPILER=/usr/bin/clang',
    '-DCMAKE_CXX_COMPILER=/usr/bin/clang++',
    ])

build_v5_0aaa_15_g287a5ae_GCC6_optim_release = TomographerBuild('v5.0aaa-15-g287a5ae', cmake_release_opts + [
...
build_v5_0_GCC6_optim_release = TomographerBuild('v5.0', cmake_release_opts + [
    '-DCMAKE_C_COMPILER=/usr/local/opt/gcc/bin/gcc-6',
    '-DCMAKE_CXX_COMPILER=/usr/local/opt/gcc/bin/g++-6',
    '-DBoost_INCLUDE_DIR=/opt/boost-1_64_0-gcc6/include',
    '-DBoost_PROGRAM_OPTIONS_LIBRARY_RELEASE=/opt/boost-1_64_0-gcc6/lib/libboost_program_options.a',
...
build_v5_0_10_g18a0196_GCC6_optim_release_noasserts_tomorunconfig = TomographerBuild('v5.0-10-g18a0196', [
...
build_v5_1_GCC6_optim_release = TomographerBuild('v5.1', cmake_release_opts + [
    '-DCMAKE_C_COMPILER=/usr/local/opt/gcc/bin/gcc-6',
    '-DCMAKE_CXX_COMPILER=/usr/local/opt/gcc/bin/g++-6',
    '-DBoost_INCLUDE_DIR=/opt/boost-1_64_0-gcc6/include',
    '-DBoost_PROGRAM_OPTIONS_LIBRARY_RELEASE=/opt/boost-1_64_0-gcc6/lib/libboost_program_options.a',
